...
export function AddContactButton() {
    ...
    return (
        <Dialog open={open} onOpenChange={setOpen}>
            ...
            <DialogContent className="bg-[hsl(var(--background-tertiary))] border-border rounded-(--radius) sm:max-w-106.25">
                <DialogHeader>
                ...
                <form ref={formRef} action={action} className="space-y-4 py-4">
                    <div className="space-y-1.5">
                        ...
                        <Input required id="name" name="name"
                            className="bg-secondary border-border text-foreground focus:border-primary rounded-(--radius) h-9 text-sm" />
                    </div>
                    ...
                    <div className="space-y-1.5">
                        ...
                        <Textarea id="notes" name="notes" rows={3}
                            className="bg-secondary border-border text-foreground focus:border-primary rounded-(--radius) text-sm resize-none" />
                    </div>
