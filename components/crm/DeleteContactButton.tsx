        ...
        <>
            ...
            {open && (
                <div
                    ...
                    role="dialog"
                    aria-modal="true"
                    aria-labelledby="del-contact-title"
                >
                    {/* Backdrop */}
                    <div
                    ...
                    <div className="relative w-full max-w-sm rounded-(--radius) bg-card border border-border shadow-2xl p-6">
                        ...
                        <p className="text-foreground-secondary text-sm leading-relaxed mb-6">
                            O contato <strong className="text-foreground">{contactName}</strong> e todo o seu histórico de
                            interações serão removidos permanentemente.
                        </p>
