                ...
                <div className="space-y-6">
                    <div className="bg-[hsl(var(--card))] border border-border rounded-(--radius) p-6">
                        ...
                        <LandingPageEditor page={{
                            ...
                            seoOgTitle: page.configJson.seo?.ogTitle,
                            seoOgDescription: page.configJson.seo?.ogDescription,
                            seoOgImageUrl: page.configJson.seo?.ogImageUrl,
                            seoCanonicalUrl: page.configJson.seo?.canonicalUrl,
